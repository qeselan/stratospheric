...
public class Network extends Construct {
    ...
    public Network(
            ...
            final com.myorg.constructs.Network.NetworkInputParameters networkInputParameters) {
    ...
    public static com.myorg.constructs.Network.NetworkOutputParameters getOutputParametersFromParameterStore(Construct scope, String environmentName) {
        return new com.myorg.constructs.Network.NetworkOutputParameters(
     ...
     */
    public com.myorg.constructs.Network.NetworkOutputParameters getOutputParameters() {
        return new com.myorg.constructs.Network.NetworkOutputParameters(
                this.vpc.getVpcId(),
    ...
    public static class NetworkInputParameters {
        ...
        public com.myorg.constructs.Network.NetworkInputParameters withSslCertificateArn(String sslCertificateArn){
