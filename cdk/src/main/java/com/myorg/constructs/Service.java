...
import com.myorg.constructs.ApplicationEnvironment;
...
/**
 * Creates an ECS service on top of a {@link Network}. Loads Docker images from a {@link dev.stratospheric.cdk.Service.DockerImageSource}
...
public class Service extends Construct {
    ...
    public Service(
            ...
            final com.myorg.constructs.Service.ServiceInputParameters serviceInputParameters,
    ...
    public static class ServiceInputParameters {
        private final com.myorg.constructs.Service.DockerImageSource dockerImageSource;
        ...
        public ServiceInputParameters(
                com.myorg.constructs.Service.DockerImageSource dockerImageSource,
         ...
         * Default: 15.
         */
        public com.myorg.constructs.Service.ServiceInputParameters withHealthCheckIntervalSeconds(int healthCheckIntervalSeconds) {
         ...
         */
        public com.myorg.constructs.Service.ServiceInputParameters withHealthCheckPath(String healthCheckPath) {
         ...
         * Default: 8080.
         */
        public com.myorg.constructs.Service.ServiceInputParameters withContainerPort(int containerPort) {
         ...
         */
        public com.myorg.constructs.Service.ServiceInputParameters withContainerProtocol(String containerProtocol) {
         ...
         * Default: 5.
         */
        public com.myorg.constructs.Service.ServiceInputParameters withHealthCheckTimeoutSeconds(int healthCheckTimeoutSeconds) {
         ...
         * Default: 2.
         */
        public com.myorg.constructs.Service.ServiceInputParameters withHealthyThresholdCount(int healthyThresholdCount) {
         ...
         * Default: 8.
         */
        public com.myorg.constructs.Service.ServiceInputParameters withUnhealthyThresholdCount(int unhealthyThresholdCount) {
         ...
         */
        public com.myorg.constructs.Service.ServiceInputParameters withCpu(int cpu) {
            this.cpu = cpu;
            return this;
        }
         ...
         * Default: 512.
         */
        public com.myorg.constructs.Service.ServiceInputParameters withMemory(int memory) {
            this.memory = memory;
            return this;
        }
         ...
         * Default: 1 week.
         */
        public com.myorg.constructs.Service.ServiceInputParameters withLogRetention(RetentionDays logRetention) {
         ...
         * Default: 2.
         */
        public com.myorg.constructs.Service.ServiceInputParameters withDesiredInstances(int desiredInstances) {
         ...
         * Default: 200.
         */
        public com.myorg.constructs.Service.ServiceInputParameters withMaximumInstancesPercent(int maximumInstancesPercent) {
         ...
         * Default: 50.
         */
        public com.myorg.constructs.Service.ServiceInputParameters withMinimumHealthyInstancesPercent(int minimumHealthyInstancesPercent) {
         ...
         */
        public com.myorg.constructs.Service.ServiceInputParameters withTaskRolePolicyStatements(List<PolicyStatement> taskRolePolicyStatements) {
         ...
         * Default: false.
         */
        public com.myorg.constructs.Service.ServiceInputParameters withStickySessionsEnabled(boolean stickySessionsEnabled) {
         ...
         */
        public com.myorg.constructs.Service.ServiceInputParameters withAwsLogsDateTimeFormat(String awsLogsDateTimeFormat) {
